...
- **共享记忆**：多个 Agent 共享的信息，比如团队规则、公共知识库
...
这类 Agent 直接和用户对话，也可以理解为“前台 Agent”。
...
这类 Agent 通常在后台运行，也可以理解为“工作流 Agent”。
...
多 Agent 系统的优势是灵活、可扩展，但设计和协调成本也更高。

> 注意：按“互动方式”分类和按“数量”分类不是互斥关系。  
> 比如，一个系统既可以是“后台 Agent”，也可以是“多 Agent 系统”。
